  ...
  return (
    <footer className="mt-16 bg-[#17243d] text-[#f7f8f4]">
      <div className="page-wrap grid gap-10 py-12 sm:grid-cols-2 lg:grid-cols-[1.3fr_1fr_1fr_1.4fr]">
        ...
        <div><p className="mb-4 text-xs font-bold uppercase tracking-[0.2em] text-[#ffb09f]">Stay curious</p><p className="mb-4 text-sm leading-6 text-white/60">A short note when we publish a new course or learning guide.</p><div className="flex gap-2"><input className="min-w-0 flex-1 rounded-xl border border-white/15 bg-white/10 px-3 py-2 text-sm outline-none placeholder:text-white/35" placeholder="Your email" type="email" /><button className="rounded-xl bg-[#ff765b] px-4 py-2 text-sm font-bold text-white">Join <FiArrowUpRight className="inline" /></button></div></div>
      </div>
