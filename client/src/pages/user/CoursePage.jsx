...
export const CoursePage = () => {
  ...
  return (
    <div className="page-wrap py-12 sm:py-16">
      <div className="mb-8 flex flex-col justify-between gap-4 border-b border-[#17243d]/10 pb-7 sm:mb-10 sm:flex-row sm:items-end sm:gap-5 sm:pb-8"><div><p className="text-xs font-black uppercase tracking-[0.2em] text-[#ff765b]">The library</p><h1 className="display-font mt-2 text-4xl text-[#17243d] sm:text-6xl">Find your next skill.</h1><p className="mt-3 max-w-lg text-[#617087]">Short, practical courses designed to move you from “I should” to “I can.”</p></div><span className="w-fit rounded-full bg-[#17243d] px-4 py-2 text-sm font-bold text-white">{courses.length} courses</span></div>
